class IngamePanelFSEconomyPanel extends TemplateElement {
    constructor() {
        super(...arguments);
    ...
    connectedCallback() {
        ...
        this.iframeElement = document.getElementById("FSEconomyIframe");
        ...
        if (this.ingameUi) {
            this.ingameUi.addEventListener("panelActive", (e) => {
                ...
                if (self.iframeElement) {
                    self.iframeElement.src = 'https://server.fseconomy.net/';
                }
            });
...
window.customElements.define("ingamepanel-fseconomy", IngamePanelFSEconomyPanel);
checkAutoload();